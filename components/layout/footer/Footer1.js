							...
							<div className="col-xxl-4 col-lg-4 col-xl-4 col-md-12 logo-footer">
								<div className="widget">
									<div className="textwidget">
										<img id="a1" src="assets/logo/tdc-logo.png" alt="images" />
										<p>
  Welcome to Thunderbolts Development Center! Join us to elevate your skills . Our expert coaches and state-of-the-art facilities are designed to help you reach your full potential in sports. Let's train, compete, and succeed together!
</p>
							...
							<div className="col-xxl-4 col-lg-4 col-xl-4 col-md-6 link-footer">
								...
								<div className="widget widget_menu-footer">
									...
									<ul className="menu-footer">
										...
										<li><Link href="/event">Special Camps</Link></li>
										<li><Link href="/about">E-Sports</Link></li>
									</ul>{/* /.menu */}
								</div>{/* /.widget */}
							</div>{/* /.col-md-4 */}
								...
								<div className="widget widget_text">
									...
									<div className="text-phone">
										...
										<div className="address">
											<p>Need help? 24/7</p>
											<span>+977 980 197 3967</span> <span>+977 980 197 3975</span>
                                            <span>info@thunderbolts.com.np</span>
						...
						<div className="row footer-bottom">
							<div className="col-md-6 col-sm-12">
								<div className="copyright">
									<p>©2025 <Link href="/" target="_blank">Thunderbolts Development Center</Link> All Rights Reserved.
									</p>
								</div>
							</div>{/* /.col-md-6 */}
							<div className="col-md-6 col-sm-12">
